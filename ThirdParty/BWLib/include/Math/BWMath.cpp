...
const double BWMath::MYPI = 3.14159265358979323;
const double BWMath::TAU = 6.28318530717958647;
const double BWMath::EULER = 2.71828182845904523;
const double BWMath::toDeg = BWMath::MYPI / 180;
const double BWMath::toRad = 180 / BWMath::MYPI;
...
{
	return BWMath::floor((BWMath::MYPI / 2) - BWMath::arcSin(p_angle), 7);
}
...
{
	return BWMath::floor((BWMath::MYPI / 2) - BWMath::arcTan(p_angle), 7);
}
